...
const projection: UnifiedUsageProjection = {
  ...
  rows: [{
    ...
    input_tokens: 10, cache_read_tokens: 2, cache_write_tokens: 1, reported_output_tokens: 3,
    output_tokens: 4, reasoning_tokens: 1, total_tokens: 15, cost_usd: null,
    provenance: "unavailable", reasoning_semantics: "unknown",
    reasoning_semantics_provenance: "unavailable", reasoning_semantics_reason: "not_reported",
    event_count: 1, source_completeness: "partial", incomplete_events: 1,
    missing_usage_events: 1, unpriced_events: 1,
    metric_provenance: { input_tokens: ["unavailable"] }, missing_metrics: { cost_microusd: 1 },
  }],
  totals: {
    event_count: 1, input_tokens: 10, cache_read_tokens: 2, cache_write_tokens: 1, reported_output_tokens: 3,
    output_tokens: 4, reasoning_tokens: 1, total_tokens: 15, cost_usd: null,
  },
  metadata: {
