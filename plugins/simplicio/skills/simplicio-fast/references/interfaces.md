...
Runtime selects Fast only from a fresh compatible Mapper handoff or an explicit
client-output-to-artifact transformation. It is not the default for an unanchored
edit or read, and it never writes source files.
