...
**كل شيء مفتوح مجانًا حتى 30 يونيو 2026.** بعد النسخة التجريبية، تتطلب ميزات AI اشتراكًا. الأوامر الحتمية (map, validate, edit, deliver, checkpoint) تبقى مجانية إلى الأبد.
